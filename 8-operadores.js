...
!false; // "!" operador not (no), negar un false da true
...
3 == "3"; // es igual, da true así uno sea un número y el otro un string son igual valores

3 === "3"; // es estrictamente igual, da falso estrictamente no son iguales
